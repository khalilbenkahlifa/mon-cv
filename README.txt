...
index.php        - Main HTML page to open the template in browser.
*.php            - Additional HTML pages (if any).
...
To edit the content open the corresponding *.php files and open them
...
index.php must be in the main (root) folder of your webserver.
